...
(see formula.v) and a witness provided, from the formula,
by the micromega OCaml plugin (see witness.v for the type).
...
See test-suite/witness_tactics.v for an example. *)
